            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h1 className="font-bold text-slate-900">{scenario.title}</h1>
                  <span
                ...
                <p className="text-xs text-slate-500 flex items-center gap-1.5">
                  ...
                  Conversation with <span className="font-medium text-slate-700">{scenario.characterName}</span>
                </p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between mt-3 pt-3 border-t border-slate-100">
            <div className="flex items-center gap-2">
              <motion.button
                ...
                className="flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-amber-700 bg-gradient-to-r from-amber-50 to-orange-50 hover:from-amber-100 hover:to-orange-100 rounded-xl border border-amber-200/50 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              {userMessageCount >= 3 && (
                <motion.button
                  ...
                  disabled={isAIResponding}
                  className="flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-emerald-700 bg-gradient-to-r from-emerald-50 to-teal-50 hover:from-emerald-100 hover:to-teal-100 rounded-xl border border-emerald-200/50 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
